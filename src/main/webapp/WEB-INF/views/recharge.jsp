...
<TITLE><fmt:message key="title.recharge" /></TITLE>
	...
	<font color="green"> <c:out value="${message}"></c:out></font>	
		<fieldset id="inputs">
			...
			<tr><br></tr>
				<tr>
					<td><fmt:message key="label.recharge.type" /></td><td>
...
<form:options items="${option}"  />
			...
			<spring:bind path="tnxrecharge.operator">
				...
				<spring:bind path="tnxrecharge.mobNo">
						<input type="text"  class="right curved borderL w100 validate[required]" name="<c:out value="${status.expression}"/>" placeholder="<fmt:message key="label.recharge.mobno" />"
		...
		<table class="center">
		<tr>
		<td><input type="submit" class="center curved borderL" id="submit" value="Recharge" /></td>
		<td>&nbsp;</td>
