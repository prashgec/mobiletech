...
<TITLE><fmt:message key="title.landLineBillPay" /></TITLE>


	
	<form name="recharge" method="post" id="page" action="landLineBillPaySubmit">
	<br>
	<h1>
	...
	<font color="green"> <c:out value="${message}"></c:out></font>	
		<fieldset id="inputs">
			...
			<tr><br></tr>
				<tr>
					<td><fmt:message key="label.landLineBillPay.type" /></td><td>
...
<form:options items="${option}"  />
			...
			<spring:bind path="tnxrecharge.operator">
					...
					<tr>
					<td><fmt:message key="label.landLineBillPay.number" /></td>
					<td>
				<spring:bind path="tnxrecharge.mobNo">
						<input type="text"  class="right curved borderL w100 validate[required]" name="<c:out value="${status.expression}"/>" placeholder="<fmt:message key="label.landLineBillPay.number" />"
				...
				<spring:bind path="tnxrecharge.tnxAmount">
					...
					<tr>
					<td><fmt:message key="label.landLineBillPay.account" /></td>
					<td>
				<spring:bind path="tnxrecharge.account">
						<input type="text"  class="right curved borderL w100 validate[required]" name="<c:out value="${status.expression}"/>" placeholder="<fmt:message key="label.landLineBillPay.account" />"
							value="<c:out value="${status.value}"/>" class="field"/>
					</spring:bind>
					</td>
					</tr>
